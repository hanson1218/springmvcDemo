...
public class SXXFWorkBookTest {
	public void jdbcex(boolean isClose) throws InstantiationException,
		...
		String url = "jdbc:mysql://119.23.202.18:3306/test?characterEncoding=UTF-8";
		String user = "root";
		String password = "Root!!2018";
		// 获取数据库连接
		Connection conn = DriverManager.getConnection(url, user, password);
		Statement stmt = conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,
				ResultSet.CONCUR_UPDATABLE);
		String sql = "select * from testBigData limit 800000"; // 100万测试数据
		...
		System.out.println("finished execute  time: "
				+ (finishedTime - startTime) / 1000 + "m");
		...
		System.out.println("write xlsx file time: " + (stopTime - startTime)
				/ 1000 + "m");
	...
	public static void main(String[] args) throws Exception {
		SXXFWorkBookTest tm = new SXXFWorkBookTest();
		tm.jdbcex(true);
	}
