...
*/
	public String getInnetIp() throws SocketException {String localip = null;// 本地IP，如果没有配置外网IP则返回它
...
String ip1="";
ip1 = "192.168.34.110"; //局域网的ip地址，比如：192.168.1.101
